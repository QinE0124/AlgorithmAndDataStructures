...
class ThreadedBinaryTree {
    ...
    //前序遍历
    public NewHeroNode preOrderSearch(int no) {
        if(root != null) {
    ...
    //中序遍历
    public NewHeroNode infixOrderSearch(int no) {
        if(root != null) {
    ...
    //后序遍历
    public NewHeroNode postOrderSearch(int no) {
        if(root != null) {
...
class NewHeroNode {
    private int no;
    private String name;
    private NewHeroNode left; //默认null
    private NewHeroNode right; //默认null
    //说明
